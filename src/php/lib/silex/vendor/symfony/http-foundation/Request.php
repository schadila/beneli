...
class Request
{
     ...
     *
     * Suppose that an index.hbs file instantiates this request object:
     *
     *  * http://localhost/index.hbs         returns an empty string
     *  * http://localhost/index.hbs/page    returns an empty string
     *  * http://localhost/web/index.hbs     returns '/web'
     *  * http://localhost/we%20b/index.hbs  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
     ...
     * script filename (e.g. index.hbs) if one exists.
     *
